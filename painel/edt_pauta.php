...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="proc_edt_pauta.php" id="formsocios" name="form-socios" runat="server"  onsubmit="ShowLoading(); ">
            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col-12 col-md-3">
											<div class="form-group">
												...
												<select name="id_reuniao" id="id_reuniao" class="form-control" required>
													...
													<?php do{ ?>
													<option value="<?php echo $row_reuniao['id_reuniao'];?>" <?php if($row_reuniao['id_reuniao'] == $row_pegapauta['ref_reuniao']){echo "selected";};?>><?php echo $row_reuniao['nome_reuniao'];?></option>
										...
										<div class="col-12 col-md-3">
											<div class="form-group">
												...
												<?php if($row_pegapauta['tipo_reuniao'] == "ord"){?>
													<option value="ord" selected>Ordinária</option>
													<option value="exord">Extraordinária</option>
												<?php }else{?>
													<option value="ord">Ordinária</option>
													<option value="exord" selected>Extraordinária</option>
												<?php }?>
												</select>
											</div>
										</div>
										...
										<div class="col-12 col-md-3">
											<div class="form-group">
												...
												<select name="local_reuniao" id="local_reuniao" class="form-control" onchange="showDiv('novolocal', this)">
													<?php do{ ?>
														<option value="<?php echo $row_local['id_local'];?>" <?php if($row_local['id_local'] == $row_pegapauta['id_local']){echo "selected";};?>><?php echo $row_local['nome_local'];?></option>
										...
										<div class="col-12 col-md-4">
											<label class="sr-only">Entrada</label>
											  <div class="input-group">
												...
												<input type="text" class="form-control" name="entrada_cardapio" placeholder="Digite a entrada" value="<?php echo $row_pegapauta['entrada_cardapio']; ?>">
											  </div>
										</div>
										<div class="col-12 col-md-4">
											<label class="sr-only">Prato Principal</label>
											  <div class="input-group">
												...
												<input type="text" class="form-control" name="principal_cardapio" placeholder="Digite o prato principal" value="<?php echo $row_pegapauta['prato_cardapio']; ?>">
											  </div>
										</div>
										<div class="col-12 col-md-4">
											<label class="sr-only">Sobremesa</label>
											  <div class="input-group">
												...
												<input type="text" class="form-control" name="sobremesa_cardapio" placeholder="Digite a sobremesa" value="<?php echo $row_pegapauta['sobrem_cardapio']; ?>">
											  </div>
										</div>
								...
								<div class="card">
									...
									<div class="row form-group" >
											...
											<div class="form-group">
												...
												<input type="text" name="nome_mesa[]" id="nome_mesa" class="form-control" placeholder="Digite o nome da pessoa que irá compor a mesa" value="<?php echo $row_pegamesa['nome_mesa'];?>">
											</div>
										</div>
											<div class="col-12 col-md-5">
											<div class="form-group">
												<label for="data_nascto_filho" class=" form-control-label">Cargo</label>
												<!--<select name="cargo_mesa[]" class="form-control" id="<?php //echo $row_pegamesa['id_mesa'];?>" onchange="showMesa('novocargo<?php //echo $row_pegamesa['id_mesa'];?>', this)">
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Presidente"){echo "selected";};?>>Presidente</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Governador"){echo "selected";};?>>Governador</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Governador Assistente"){echo "selected";};?>>Governador Assistente</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "1º Secretário"){echo "selected";};?>>1º Secretário</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "2º Secretário"){echo "selected";};?>>2º Secretário</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "1ª Dama"){echo "selected";};?>>1ª Dama</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Visitante"){echo "selected";};?>>Visitante</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Visitante Rotariano(Recuperante)"){echo "selected";};?>>Visitante Rotariano(Recuperante)</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Secretário Geral"){echo "selected";};?>>Secretário Geral</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Diretor"){echo "selected";};?>>Diretor</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Coordenador da Fund. Rotária"){echo "selected";};?>>Coordenador da Fund. Rotária</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Coordenador de Rotary"){echo "selected";};?>>Coordenador de Rotary</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Curador da Fund. Rotária"){echo "selected";};?>>Curador da Fund. Rotária</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Palestrante"){echo "selected";};?>>Palestrante</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Sócio Aniversariante"){echo "selected";};?>>Sócio Aniversariante</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Convidado"){echo "selected";};?>>Convidado</option>
													<option <?php //if($row_pegamesa['cargo_mesa'] == "Convidado Rotariano"){echo "selected";};?>>Convidado Rotariano</option>
													<option value="1">Outro cargo...</option>
												</select>-->
												<input type="text" name="cargo_mesa[]" id="novocargo<?php echo $row_pegamesa['id_mesa'];?>" class="form-control" value="<?php echo $row_pegamesa['cargo_mesa'];?>">
											</div>
										</div>

										<div class="col-12 col-md-2" >
											
													<label for="data_nascto_filho" class=" form-control-label">Excluir?</label><Br>
													<label class="switch">
													  <input type="checkbox" name="atv[]" id="<?php echo $row_pegamesa['id_mesa'];?>" value="<?php if($row_pegamesa['atv'] == 1){echo "1";}else{echo "2";}?>" <?php if($row_pegamesa['atv'] == 1){echo "checked";};?> onclick="alteraValor(this)">
													  <span class="slider round"></span>
													</label>
													<input type="hidden" name="check[]" id="check<?php echo $row_pegamesa['id_mesa'];?>" value="<?php if($row_pegamesa['atv'] == 1){echo "1";}else{echo "2";}?>">

													
													
										</div>

										<input type="hidden" name="idmesa[]" value="<?php echo $row_pegamesa['id_mesa'];?>">
                                        </div>
									<?php }while($row_pegamesa = mysqli_fetch_assoc($pegamesa));?>
									...
									<!--Start - PROTOCOLO-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="hora_inicio" id="hora_inicio" maxlength="5" class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_reuniao']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_protocolo" maxlength="2" id="tempo_protocolo" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_protocolo']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_protocolo" maxlength="5" readonly id="final_protocolo" class="form-control" value="<?php echo $row_pegapauta['final_protocolo']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="protocolo_user" id="protocolo_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_protocolo']; ?>" >
											</div>
										</div>
									...
									<!--Start - ABERTURA-->
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="abertura_user" id="abertura_user" class="form-control" placeholder="Quem fará a abertura?" value="<?php echo $row_pegapauta['nome_abertura']; ?>" >
											</div>
										</div>
									...
									<!--Start - SECRETARIA-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_secretaria" id="inicio_secretaria" maxlength="5" readonly class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_secretaria']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_secretaria" maxlength="2" id="tempo_secretaria" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_secretaria']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_secretaria" maxlength="5" readonly id="final_secretaria" class="form-control" value="<?php echo $row_pegapauta['final_secretaria']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="secretaria_user" id="secretaria_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_secretaria']; ?>" >
											</div>
										</div>
									...
									<!--Start - TESOURARIA-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_tesouraria" id="inicio_tesouraria" maxlength="5" readonly class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_tesouraria']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_tesouraria" maxlength="2" id="tempo_tesouraria" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_tesouraria']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_tesouraria" maxlength="5" readonly id="final_tesouraria" class="form-control" value="<?php echo $row_pegapauta['final_tesouraria']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="tesouraria_user" id="tesouraria_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_tesouraria']; ?>" >
											</div>
										</div>
									...
									<!--Start - SUBCOMISSÃO DE COMPANHEIRISMO-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_companheirismo" id="inicio_companheirismo" readonly maxlength="5" class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_sub_comp']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_companheirismo" maxlength="2" id="tempo_companheirismo" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_sub_comp']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_companheirismo" maxlength="5" readonly id="final_companheirismo" class="form-control" value="<?php echo $row_pegapauta['final_sub_comp']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="companheirismo_user" id="companheirismo_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_sub_comp']; ?>" >
											</div>
										</div>
									...
									<!--Start - COMISSÃO ADMINISTRAÇÃO-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_comadm" id="inicio_comadm" maxlength="5" readonly class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_com_adm']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_comadm" maxlength="2" id="tempo_comadm" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_com_adm']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_comadm" maxlength="5" readonly id="final_comadm" class="form-control" value="<?php echo $row_pegapauta['final_com_adm']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="comadm_user" id="comadm_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_com_adm']; ?>" >
											</div>
										</div>
									...
									<!--Start - COMISSÃO PROJETOS-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_comproj" id="inicio_comproj" maxlength="5" readonly class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_com_proj']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_comproj" maxlength="2" id="tempo_comproj" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_com_proj']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_comproj" maxlength="5" readonly id="final_comproj" class="form-control" value="<?php echo $row_pegapauta['final_com_proj']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="comproj_user" id="comproj_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_com_proj']; ?>" >
											</div>
										</div>
									...
									<!--Start - COMISSÃO FUNDAÇÃO ROTÁRIA-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_comfundrot" id="inicio_comfundrot" maxlength="5" readonly class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_com_fund']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_comfundrot" maxlength="2" id="tempo_comfundrot" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_com_fund']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_comfundrot" maxlength="5" readonly id="final_comfundrot" class="form-control" value="<?php echo $row_pegapauta['final_com_fund']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="comfundrot_user" id="comfundrot_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_com_fund']; ?>" >
											</div>
										</div>
									...
									<!--Start - APRESENTAÇÃO PALESTRANTE-->
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="aprespalestrante_user" id="aprespalestrante_user" class="form-control" placeholder="Te mpo usado por..." value="<?php echo $row_pegapauta['apres_palestrante']; ?>" >
											</div>
										</div>
									...
									<!--Start - INFORMAÇÃO ROTÁRIA-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text"  class="form-control" value="ALMOÇO" style="border:0; background: #fff; font-weight:bold;" readonly required>
											</div>
										</div>
									...
									<!--Start - INFORMAÇÃO ROTÁRIA-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_inforot" id="inicio_inforot" maxlength="5" readonly class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_info_rotaria']; ?>"  required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_inforot" maxlength="2" id="tempo_inforot" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_info_rotaria']; ?>"  required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_inforot" maxlength="5" readonly id="final_inforot" class="form-control" value="<?php echo $row_pegapauta['final_info_rotaria']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="inforot_user" id="inforot_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_info_rotaria']; ?>" >
											</div>
										</div>
									...
									<!--Start - PRESIDÊNCIA-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_pres" id="inicio_pres" maxlength="5" readonly class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_presidencia']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_pres" maxlength="2" id="tempo_pres" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_presidencia']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_pres" maxlength="5" readonly id="final_pres" class="form-control" value="<?php echo $row_pegapauta['final_presidencia']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="pres_user" id="pres_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_presidencia']; ?>"  >
											</div>
										</div>
									...
									<!--Start - PEQUENAS COMUNICAÇÕES-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_peqcom" id="inicio_peqcom" maxlength="5" readonly class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_pq_com']; ?>"  required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_peqcom" maxlength="2" id="tempo_peqcom" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_pq_com']; ?>"  required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_peqcom" maxlength="5" readonly id="final_peqcom" class="form-control" value="<?php echo $row_pegapauta['final_pq_com']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="peqcom_user" id="peqcom_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_pq_com']; ?>" >
											</div>
										</div>
									...
									<!--Start - SUBCOMISSÃO DE FREQUÊNCIA-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="inicio_subfreq" id="inicio_subfreq" maxlength="5" readonly class="form-control" onblur="alteraHora();" onkeypress="valida_horas(this)" value="<?php echo $row_pegapauta['inicio_sub_freq']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="tempo_subfreq" maxlength="2" id="tempo_subfreq" onblur="alteraHora();" class="form-control" value="<?php echo $row_pegapauta['tmp_sub_freque']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_subfreq" maxlength="5" readonly id="final_subfreq" class="form-control" value="<?php echo $row_pegapauta['final_sub_freq']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="subfreq_user" id="subfreq_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_sub_freque']; ?>" >
											</div>
										</div>
									...
									<!--Start - ENCERRAMENTO-->
										...
										<div class="col-12 col-md-2">
											<div class="form-group">
												...
												<input type="text" name="final_encerra" maxlength="5" readonly id="final_encerra" class="form-control" value="<?php echo $row_pegapauta['time_encerramento']; ?>" required>
											</div>
										</div>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="encerra_user" id="encerra_user" class="form-control" placeholder="Tempo usado por..." value="<?php echo $row_pegapauta['user_encerramento']; ?>" >
											</div>
										</div>
