...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="previsao_proc_cd_pagar.php" name="form-contabancaria">
            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col">
											<div class="form-group">
												...
												<input type="text" name="descricao_pagar" id="descricao_pagar" placeholder="Ex.: Valor referente ao pagamento de José" class="form-control" required>
											</div>
										</div>
										<div class="col">
											<div class="form-group">
                                        ...
                                        <div class="row form-group">
											...
											<div class="col">
                                                <div class="form-group">
													...
													<input type="text" name="valor_pagar" onKeyPress="return(moeda(this,'.',',',event))" id="valor_receita" class="form-control" required>
													</div>
