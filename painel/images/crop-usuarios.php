...
$data = date("d-m-Y-H-i");
$recebeimg = "image/usuarios/".$data."-".$_FILES['imagem']['name'];
$codusuario = 943000090;

$sql = "UPDATE rfa_usuario SET imagem = '$recebeimg' WHERE cod_usuario='$codusuario'";
		...
		<?php else: ?>
			<form name="frm-jcrop" id="frm-jcrop" method="post" action="crop-simples.php" enctype="multipart/form-data">
				<p>
					...
					<input type="hidden" name="img2" value="<?php echo $caminho;?>">
