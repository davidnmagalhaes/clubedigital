...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="proc_cd_serv_comunidade.php" id="formsocios" name="form-socios" runat="server"  onsubmit="ShowLoading(); ">
            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col-12 col-md-4">
											...
											<label for="nome_socio" class=" form-control-label">Nome do Serviço</label>
												<input type="text" name="nome_servico" id="nome_servico" class="form-control">
											</div>
										</div>
