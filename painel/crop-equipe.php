...
$sql = "UPDATE rfa_usuario SET imagem = '$recebeimg' WHERE cod_usuario='$coduser' AND clube='$club'";
...
<script src="https://kit.fontawesome.com/13f03eba23.js" crossorigin="anonymous"></script>
	...
	<body>
				...
				$(function(){
					...
					$('#btn-crop').click(function(){
						$.post( 'crop.php', {
							...
							window.location = "https://www.clubedigital.ong.br/painel/equipe";
						});
						return false;
					});
				});
		...
		<?php else: ?>
			...
			<form name="frm-jcrop" id="frm-jcrop" method="post" action="crop-equipe.php" enctype="multipart/form-data" runat="server"  onsubmit="ShowLoading(); ">
