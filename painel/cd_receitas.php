...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="proc_cd_receitas.php" name="form-contabancaria">
            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col">
											<div class="form-group">
												...
												<input type="text" name="descricao_receita" id="descricao_receita" placeholder="Ex.: Valor referente ao pagamento de José" class="form-control" required>
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												<label for="data_receita" class=" form-control-label">Data de Recebimento</label>
												<input type="date" name="data_receita" id="data_receita" class="form-control" required>
											</div>
										</div>
										</div>
                                        <div class="row form-group">
											...
											<div class="col">
                                                <div class="form-group">
													...
													<input type="text" name="valor_receita" onKeyPress="return(moeda(this,'.',',',event))" id="valor_receita" class="form-control" required data-toggle="tooltip" data-placement="top" title="Este valor será creditado na conta de destino escolhida.">
													</div>
