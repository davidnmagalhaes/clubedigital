...
$recebeimg = "images/sites/clube".$club."/galeria/".$data."-".$_FILES['imagem']['name'];


$sql = "UPDATE rfa_site_galeria SET imagem_presidente = '$recebeimg' WHERE cod_galeria='$coduser' AND clube='$club'";
...
<html>
	<head>
		...
		<title>Imagem do Presidente</title>
...
<script src="https://kit.fontawesome.com/13f03eba23.js" crossorigin="anonymous"></script>
	...
	<body>
		...
		<?php
			...
			$tem_crop	= false;
			$img		= '';
			$caminho = "images/sites/clube".$club."/galeria/".$data."-".$imagem['name'];
			if( $imagem['tmp_name'] ) 
			{
				...
				$(function(){
					...
					$('#btn-crop').click(function(){
						$.post( 'crop.php', {
							...
							window.location = "https://www.clubedigital.ong.br/painel/galeria";
						});
						return false;
					});
				});
		...
		<?php else: ?>
			<h1>UPLOAD DE IMAGEM DO PRESIDENTE</h1>

			<form name="frm-jcrop" id="frm-jcrop" method="post" action="crop-galeria.php" enctype="multipart/form-data" runat="server"  onsubmit="ShowLoading(); ">
										...
										<div class="row" style="margin-bottom: 15px">
                                    		<div class="col-12">
                                                ...
                                                <span class="fake-btn"><strong style="color:#4272d7"><i class="fas fa-cloud-upload-alt" style="margin-right: 15px; font-size: 25px;"></i> Imagem do Presidente</strong></span>
