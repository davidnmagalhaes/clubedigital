...
$qrh = "SELECT * FROM rfa_datas_importantes WHERE clube='$clube' ORDER BY mes_data_imp, dia_data_imp ASC";
...
$(document).ready(function(){
    $("a.exclui").click(function(e){
        if(!confirm('Tem certeza que deseja excluir esta data importante?')){
            e.preventDefault();
            return false;
        }
        return true;
            ...
            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
									...
									<h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-assignment"></i>Datas Importantes
									<a href="cd_data_importante.php" role="button" class="btn btn-success">
                                            <i class="fas fa-plus"></i> Data Importante</a>									
									 </h3>
...
<div class="rs-select2--dark rs-select2--md m-r-10 rs-select2--border" style="margin-left: 35px">
                                    ...
                                    <div class="table-responsive table-data">
                                        <table class="table">
                                            ...
                                            <tbody>
											<?php if($totalRows_lish <= 0){echo "<tr><td colspan='6' align='center'>Nenhuma data importante encontrada!</td></tr>";}else{?>
											<?php do{ ?>
                                                <tr>
                                                    <td>
                                                        <label class="au-checkbox">
                                                    ...
                                                    <td>
                                                        <div class="table-data__info">
                                                            ...
                                                            <h6><?php echo $row_lish['dia_data_imp'];?></h6>
													...
													<td>
                                                        <div class="table-data__info">
                                                            ...
                                                            <span class="block-email">
															  ...
															  echo strtoupper(strftime('%B',strtotime(date("Y")."-".$row_lish['mes_data_imp']."-"."01")));?>
                                                            </span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
														<span class="block-email">
                                                               <?php echo $row_lish['nome_data_imp'];?>
                                                          </span>
													</td>
                                                    ...
                                                    <td>
                                                       <a href="edt_data_importante.php?id_data_imp=<?php echo $row_lish['id_data_imp'];?>&clube=<?php echo $_SESSION['clube'];?>">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </a>
                                                    </td>
													<td>
                                                       <a href="excluir-data-importante.php?id_data_imp=<?php echo $row_lish['id_data_imp'];?>&clube=<?php echo $_SESSION['clube'];?>" class="exclui">
