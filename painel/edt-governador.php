...
$qrh = "SELECT * FROM rfa_site_governadores WHERE clube='$club' AND cod_governador='$idgaleria'";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
  <form action="proc_edt_site_governador.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-12">
               <!-- USER DATA-->
                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                      ...
                                      <div class="row">
                                          <div class="col-12 col-md-3">
                                              ...
                                              <input type="text" name="nome_presidente" class="form-control" placeholder="Digite o nome do presidente" value="<?php echo $row_lish['nome_governador'];?>">
                                          </div>
                                ...
                                <input type="hidden" name="idgaleria" value="<?php echo $row_lish ['cod_governador'];?>">
  </form>
