...
foreach($pegaadmiss as $pegaadmi){
	...
	$dataadmiss .= date('d/m',strtotime($pegaadmi['data_admissao']))." - ".$pegaadmi['nome_socio']." <strong>(".$intervalo->y." anos de associado(a))</strong><Br>";
}
}
...
<table>
	<tr>
		<td>".$row_pegapauta['sec_reuniao']."</td>
	</tr>
	<tr>
		<td class='line'>
			&nbsp;
