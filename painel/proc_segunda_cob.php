...
use PHPMailer\PHPMailer\Exception;
		...
		require("phpmailer/vendor/autoload.php");
			...
			$mail->Subject  = 'Mensalidade pendente'; // Assunto da mensagem
			$mail->Body = '
<table cellpadding="0" cellspacing="0" border="0" width="600" style="font-family: calibri;">
	...
	<tr>
		<td style="text-align:center; padding: 20px">
			...
			Infelizmente sua mensalidade não foi paga, pedimos que por gentileza regularize suas pendências no clube o qual está associado(a).
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td style="text-align:center; padding: 20px">
			<strong>Caso já tenha pago a mensalidade ignore este lembrete. Se encontrou dificuldades para realizar o pagamento entre em contato com o responsável por seu clube.</strong>
...
if ($mail->Send()) {
		echo "<script>javascript:alert('Segunda cobrança enviada com sucesso!');javascript:window.location='home.php'</script>";
