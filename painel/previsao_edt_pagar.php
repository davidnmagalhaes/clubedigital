...
$qr = "SELECT * FROM rfa_prev_pagar WHERE clube='$clube' AND id_prev_pagar='$idpagar'";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="previsao_proc_edt_pagar.php" name="form-contabancaria">
            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col">
											<div class="form-group">
												...
												<input type="text" name="descricao_pagar" id="descricao_pagar" placeholder="Ex.: Valor referente ao pagamento de José" value="<?php echo $row_lis['desc_prev_pagar'];?>" class="form-control" required>
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												<label for="data_receita" class=" form-control-label">Data de Pagamento</label>
												<input type="date" name="data_pagar" id="data_pagar" value="<?php echo $row_lis['data_prev_receitas'];?>" class="form-control" required>
											</div>
										</div>
										</div>
                                        <div class="row form-group">
											...
											<div class="col">
                                                <div class="form-group">
													...
													<input type="text" name="valor_pagar" onKeyPress="return(moeda(this,'.',',',event))" id="valor_receita" class="form-control" value="<?php echo number_format($row_lis['valor_prev_pagar'],2,',','.');?>" required>
													</div>
                                            ...
                                            <div class="col">
                                                ...
                                                <select class="form-control" name="categoria">
                                                    <?php while($row_vercat = mysqli_fetch_array($vercat)){?>
                                                        <option value="<?php echo $row_vercat['id_categoria']; ?>" <?php if($row_vercat['id_categoria'] == $row_lis['cat_prev_pagar']){echo "selected";}?>><?php echo $row_vercat['nome_categoria'];?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
