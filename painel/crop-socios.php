...
$recebeimg = "images/socios/".$data."-".$_FILES['imagem']['name'];


$sql = "UPDATE rfs_socios SET imagem = '$recebeimg' WHERE ref_socio='$coduser' AND clube='$club'";
...
<script src="https://kit.fontawesome.com/13f03eba23.js" crossorigin="anonymous"></script>
	...
	<body>
		...
		<?php
			...
			$tem_crop	= false;
			$img		= '';
			$caminho = "images/socios/".$data."-".$imagem['name'];
			if( $imagem['tmp_name'] ) 
			{
				...
				$(function(){
					...
					$('#btn-crop').click(function(){
						$.post( 'crop.php', {
							...
							window.location = "https://www.clubedigital.ong.br/painel/socios";
						});
						return false;
					});
				});
		...
		<?php else: ?>
			<h1>UPLOAD DE IMAGEM DO SÓCIO</h1>

			<form name="frm-jcrop" id="frm-jcrop" method="post" action="crop-socios.php" enctype="multipart/form-data" runat="server"  onsubmit="ShowLoading(); ">
										...
										<div class="row" style="margin-bottom: 15px">
                                    		<div class="col-12">
                                                ...
                                                <span class="fake-btn"><strong style="color:#4272d7"><i class="fas fa-cloud-upload-alt" style="margin-right: 15px; font-size: 25px;"></i> Imagem do Sócio</strong></span>
