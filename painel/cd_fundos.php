...
<head>
    ...
    <!-- Title Page-->
    <title>Cadastro de Fundos - Rotary Fortaleza Alagadiço</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="proc_cd_fundos.php" name="form-contabancaria">
            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col">
											<div class="form-group">
												...
												<input type="text" name="descricao_fundo" id="descricao_fundo" class="form-control" required>
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												<label for="data_pagar" class=" form-control-label">Vencimento</label>
												<input type="date" name="data_fundo" id="data_fundo" class="form-control" required>
											</div>
										</div>
										</div>
                                        <div class="row form-group">
											...
											<div class="col">
                                                <div class="form-group">
													...
													<input type="text" name="valor_fundo" onKeyPress="return(moeda(this,'.',',',event))" id="valor_fundo" class="form-control" required data-toggle="tooltip" data-placement="top" title="Este valor será debitado da conta de origem escolhida.">
													</div>
