            ...
            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <form action="previsao-acao-pagar.php" method="post" id="mainForm">
                                                <input type="hidden" name="clube" value="<?php echo $clube;?>">
										...
										<?php do{ ?>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="desc" contenteditable="true" data-old_value="<?php echo $row_lis['desc_prev_pagar']; ?>" onBlur="saveInlineEdit(this,'desc_prev_pagar','<?php echo $row_lis['id_prev_pagar']; ?>')" onClick="highlightEdit(this);" scope="row" ><?php echo $row_lis['desc_prev_pagar'];?></td>
