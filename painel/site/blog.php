...
$sblog = "SELECT * FROM rfa_site_blog WHERE clube='$clube'";
$blog = mysqli_query($link, $sblog) or die(mysqli_error($link));
$totalRows_blog = mysqli_num_rows($blog);

//Contar o total de cursos
$total_blog = mysqli_num_rows($blog);

//Seta a quantidade de cursos por pagina
$quantidade_pg = 2;

//calcular o número de pagina necessárias para apresentar os cursos
$num_pagina = ceil($total_blog/$quantidade_pg);

//Calcular o inicio da visualizacao
$incio = ($quantidade_pg*$pagina)-$quantidade_pg;

$sblog44 = "SELECT * FROM rfa_site_blog WHERE clube='$clube' ORDER BY id_blog DESC limit $incio, $quantidade_pg";
                  ...
                  <div class="feature-post">
                     ...
                     <div class="feature-cont">
                        ...
                        <div class="post-heading">
                           ...
                           <p class="short-description2"><?php echo $row_blog44['descricao_blog'];?>
                           </p>
                           <?php if($signal == 1){?>
                           <a href="post?id_blog=<?php echo $row_blog44['id_blog']; ?>" class="btn btn-primary" role="button">VER MAIS</a>
                           <?php }else{?>
                           <a href="single-blog.php?clube=<?php echo $clube; ?>&id_blog=<?php echo $row_blog44['id_blog']; ?>" class="btn btn-primary" role="button">VER MAIS</a>
                           <?php }?>
                        </div>
                     </div>
                  <?php } ?>
               ...
               <?php 
                  ...
                  for($i = $inicio; $i <= $fim; $i++){
                     ...
                     if($i == $pagina){
                       ...
                       echo "<li ><a href='blog.php?clube=".$clube."&pagina=$i'>".$i."</a></li>";
                       }
                     }
