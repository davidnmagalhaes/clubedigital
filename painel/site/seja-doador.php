...
<html lang="pt-br">
   ...
   <title><?php echo $row_topo['title_seo']." | Seja doador de Cadeira de Rodas"; ?></title>
...
<?php include('header.php'); ?>
         ...
         <div class="inner-page-banner">
            <div class="container">
<h1 class="titulo-topo" style="font-size: 70px !important;">Seja doador</h1>
            </div>
               ...
               <div class="contact">
                  ...
                  <div class="col-md-6">
                     <div class="contact-us">
                        <form method="post" action="<?php if($signal == 1){echo "continuadoador";}else{echo "continua-doador.php";}?>"> 
                           <ul>
