...
<!DOCTYPE html>
<html lang="pt-br">
   <title><?php echo $row_topo['title_seo']." | Galeria de Presidentes"; ?></title>
         ...
         <div class="row">
            <div class="container">
               ...
               <div class="col-md-3 column">
                  <div class="card2">
                     <img class="img-responsive" src="<?php if($signal == 1){echo "painel/";}else{echo "../";}?><?php if(empty($row_socios['imagem_presidente']) && $row_socios['sexo'] =='m'){echo 'images/male.jpg';}elseif(empty($row_socios['imagem_presidente']) && $row_socios['sexo'] =='f'){echo 'images/female.jpg';}else{echo $row_socios['imagem_presidente'];}?>" style="width:100%">
                     <div class="">
