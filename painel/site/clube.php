...
<html lang="pt-br">
   ...
   <title><?php echo $row_topo['title_seo']." | Sobre o Clube"; ?></title>
...
<?php include('header.php'); ?>
         ...
         <div class="inner-page-banner">
            <div class="container">
               <h1 class="titulo-topo">O Clube</h1>
            </div>
         </div>
      </section>
      <section id="contant" class="contant main-heading" style="padding-bottom:40px;margin-bottom:-1px;position:relative;z-index:1;">
         <div class="aboutus">
            <div class="container">
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="full">
                           <h3><?php echo $row_club['title_site_clube'];?></h3>
                           <p>
                              <?php echo $row_club['texto_site_clube'];?>
                           </p>
                           <!--<ul class="icon-list">
                     ...
                     <div class="col-md-5 col-sm-5 col-xs-12">
                        <img class="img-responsive" src="<?php if($signal == 1){echo "painel/";}else{echo "../";}?><?php echo $row_club['img_clube'];?>" alt="#" />
                     </div>
                  </div>
               </div>
            </div>
