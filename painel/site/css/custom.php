...
.titulo-topo{
    position:relative; top: 392px; color: #fff; font-size: 100px
}
...
.footer-widget p {
 ...
 .inner-page-banner {
     ...
     width: 100%;
     min-height: 500px;
     background-image: url('../../<?php if(empty($capa)){echo "images/avatarbanner.jpg";}else{echo $capa;} ?>');
     background-position: center center;
     background-repeat: no-repeat;
     background-size: cover;
     position: relative;
...
section#contant h4 {
 ...
 .theme-padding.middle-bg {
     ...
     background-image: url(../../<?php if(empty($imgvideo)){echo "images/avatarbanner.jpg";}else{echo $imgvideo;} ?>);
     background-repeat: no-repeat;
