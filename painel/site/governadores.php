...
$ssoc = "SELECT * FROM rfa_site_governadores WHERE clube='$clube' ORDER BY ano_rotario_i DESC";
...
<!DOCTYPE html>
<html lang="pt-br">
   <title><?php echo $row_topo['title_seo']." | Galeria de Governadores"; ?></title>
...
<?php include('header.php'); ?>
         ...
         <div class="inner-page-banner">
            <div class="container">
<h1 class="titulo-topo" style="font-size: 70px !important;">Galeria de Governadores</h1>
            </div>
         ...
         <div class="row">
            <div class="container">
               ...
               <div class="col-md-3 column">
                  <div class="card2">
                     <img class="img-responsive" src="<?php if($signal == 1){echo "painel/";}else{echo "../";}?><?php if(empty($row_socios['imagem_governador']) && $row_socios['sexo'] =='m'){echo 'images/male.jpg';}elseif(empty($row_socios['imagem_governador']) && $row_socios['sexo'] =='f'){echo 'images/female.jpg';}else{echo $row_socios['imagem_governador'];}?>" style="width:100%">
                     <div class="">
                        <h4><?php echo $row_socios['nome_governador'];?></h4>
