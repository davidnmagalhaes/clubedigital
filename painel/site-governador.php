...
$qrh = "SELECT * FROM rfa_site_governadores WHERE clube='$clube'";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
  <form action="proc_cd_site_governador.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-12">
               <!-- USER DATA-->
                <div class="card">
                                    <div class="card-header">
                                        <strong>Galeria de Governadores</strong>
                                        <small> Gestão de Ex-Governadores</small>
                                    </div>
                                    <div class="card-body card-block">
                                      ...
                                      <div class="row">
                                          <div class="col-12 col-md-3">
                                              <label for="titulo" class="col-form-label">Nome do Governador:</label>
                                ...
                                <input type="hidden" name="por" value="<?= $_SESSION['id_usuario'] ?>">
                                    ...
                                    <div class="card-header">
                                        <strong>Governadores cadastrados na galeria</strong>
...
<table class="table table-striped">
  <?php if($totalRows_lish <= 0){echo "<tr><td colspan='5' align='center'><strong>Não há governadores cadastrados!</strong></td></tr>";}else{ ?>
  <thead>
    <tr>
      <th scope="col" style=" text-align:center;">Imagem</th>
      <th scope="col">Ano Rotário</th>
      <th scope="col">Nome do Governador</th>
      <th scope="col"></th>
      <th scope="col"></th>
      <th scope="col"></th>
    </tr>
  ...
  <tbody>
    ...
    <tr>
      <th style="vertical-align:middle; text-align:center;"><img src="<?php echo $row_lish['imagem_governador']; ?>" style="width: 150px; border-radius: 100%;"></th>
      <td style="vertical-align:middle;"><?php echo $row_lish['ano_rotario_i']."/".$row_lish['ano_rotario_f']; ?></td>
      <td style="vertical-align:middle;"><?php echo $row_lish['nome_governador']; ?></td>
      <td style="vertical-align:middle;"><a href="edt-governador.php?id_galeria=<?php echo $row_lish['cod_governador']; ?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>"><i class="fas fa-pen-alt"></i></a></td>
      <td style="vertical-align:middle;"><a href="crop-governador.php?cod_usuario=<?php echo $row_lish['cod_governador']; ?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>"><i class="far fa-image"></i></a></td>
      <td style="vertical-align:middle;"><a href="excluir-site-governador.php?id_galeria=<?php echo $row_lish['cod_governador']; ?>&clube=<?php if($_GET['clube']){echo $clube;}else{echo $clube;}?>"><i class="fas fa-trash"></i></a></td>
    </tr>
    <?php } ?>
