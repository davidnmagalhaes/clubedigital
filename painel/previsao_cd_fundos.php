...
<head>
    ...
    <!-- Title Page-->
    <title>Cadastro de Despesas Previstas - Rotary Fortaleza Alagadiço</title>
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col">
											<div class="form-group">
												...
												<input type="text" name="descricao_fundos" id="descricao_fundos" placeholder="Ex.: Valor referente ao pagamento de José" class="form-control" required>
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												<label for="data_receita" class=" form-control-label">Data de Pagamento</label>
												<input type="date" name="data_fundos" id="data_fundos" class="form-control" required>
											</div>
										</div>
										</div>
                                        <div class="row form-group">
											...
											<div class="col">
                                                <div class="form-group">
													...
													<input type="text" name="valor_fundos" onKeyPress="return(moeda(this,'.',',',event))" id="valor_fundos" class="form-control" required>
													</div>
