...
$clube = $_GET['clube'];
$idprofissional = $_GET['id_profissional'];

//Conexão com banco de dados
include_once("config.php");

$s = "SELECT * FROM rfa_servicos_profissionais WHERE id_prof='$idprofissional' AND clube='$clube'";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="proc_edt_serv_profissionais.php" id="formsocios" name="form-socios" runat="server"  onsubmit="ShowLoading(); ">
            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<select name="dia_profissional" id="dia_profissional" class="form-control" required>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<select name="mes_profissional" id="mes_profissional" class="form-control" required>
										...
										<div class="col-12 col-md-4">
											...
											<label for="nome_socio" class=" form-control-label">Nome do Serviço</label>
												<input type="text" name="nome_servico" id="nome_servico" class="form-control" value="<?php echo $row_servico['nome_prof'];?>">
											</div>
										</div>
									...
									<input type="hidden" name="idservico" value="<?php echo $idprofissional; ?>">
