...
if($pginc == ""){
	$sql = "UPDATE rfa_clubes SET urldominio = '$urldominio',secret_key='$secretkey',site_key='$sitekey',paghiper_taxa = '$taxapaghiper', paghiper_include = '$includeretorno', paghiper_appkey = '$appkeypaghiper', paghiper_token = '$tokenpaghiper', pagseguro_email='$emailpagseguro', pagseguro_token='$tokenpagseguro' WHERE id_clube = '$club';";
...
// END - Cria um arquivo de include para ser utilizado no retorno pegando a chave e o token do usuário
	...
	$sql = "UPDATE rfa_clubes SET urldominio = '$urldominio',secret_key='$secretkey',site_key='$sitekey',paghiper_taxa = '$taxapaghiper', paghiper_appkey = '$appkeypaghiper', paghiper_token = '$tokenpaghiper',pagseguro_email='$emailpagseguro', pagseguro_token='$tokenpagseguro' WHERE id_clube = '$club';";
