...
/*Variáveis do upload do logotipo*/
	...
	$sql = "INSERT INTO rfa_site_governadores (cod_governador, nome_governador, ano_rotario_i, ano_rotario_f, sexo, clube) VALUES ('$codgaleria','$nomepresidente', '$anorotarioi', '$anorotariof', '$sexo', '$club');";
}else{
...
/*Variáveis do upload do logotipo*/
	...
	if ($link->multi_query($sql) === TRUE) {
		...
		echo "<script>javascript:window.location='crop-governador.php?cod_usuario=".$codgaleria."&clube=".$club."'</script>";
	} else {
