...
$clube = $_GET['clube'];
$idcomunidade = $_GET['id_comunidade'];

//Conexão com banco de dados
include_once("config.php");

$s = "SELECT * FROM rfa_servicos_comunidade WHERE id_servico='$idcomunidade' AND clube='$clube'";
...
<head>
    ...
    <!-- Title Page-->
    <title>Cadastro de Serviços à Comunidade - Rotary Fortaleza Alagadiço</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="proc_edt_serv_comunidade.php" id="formsocios" name="form-socios" runat="server"  onsubmit="ShowLoading(); ">
            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Atualização</strong>
                                        <small> de Serviços à Comunidade</small>
                                    </div>
                                    <div class="card-body card-block">
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<select name="dia_comunidade" id="dia_comunidade" class="form-control" required>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<select name="mes_comunidade" id="mes_comunidade" class="form-control" required>
										...
										<div class="col-12 col-md-4">
											...
											<label for="nome_socio" class=" form-control-label">Nome do Serviço</label>
												<input type="text" name="nome_servico" id="nome_servico" class="form-control" value="<?php echo $row_servico['nome_servico'];?>">
											</div>
										</div>
									...
									<input type="hidden" name="idservico" value="<?php echo $idcomunidade; ?>">
