...
<head>
    ...
    <!-- Title Page-->
    <title>Cadastro de Retiradas Previstas - Rotary Fortaleza Alagadiço</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.0/jquery.min.js"></script>
 ...
 <div class="main-content">
			<form method="post" action="previsao_proc_cd_retiradas.php" name="form-contabancaria">
            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col">
											<div class="form-group">
												...
												<input type="text" name="descricao_retiradas" id="descricao_retiradas" placeholder="Ex.: Valor referente a retirada do mês de agosto" class="form-control" required>
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												<label for="data_receita" class=" form-control-label">Data de Retirada</label>
												<input type="date" name="data_retiradas" id="data_retiradas" class="form-control" required>
											</div>
										</div>
										</div>
                                        <div class="row form-group">
											...
											<div class="col">
                                                <div class="form-group">
													...
													<input type="text" name="valor_retiradas" onKeyPress="return(moeda(this,'.',',',event))" id="valor_retiradas" class="form-control" required>
													</div>
