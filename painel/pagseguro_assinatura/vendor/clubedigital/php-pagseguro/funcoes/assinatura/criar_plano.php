...
$urlcancelamento = "https://".$_SERVER['HTTP_HOST']."/".basename(__DIR__)."/pagseguro_assinatura/vendor/clubedigital/php-pagseguro/funcoes/assinatura/cancelamento.php";
$urlredirect = "https://".$_SERVER['HTTP_HOST']."/".basename(__DIR__)."/pagseguro_assinatura/vendor/clubedigital/php-pagseguro/funcoes/assinatura/cancelamento.php";
