...
$recebeimg = "images/sites/clube".$club."/governadores/".$data."-".$_FILES['imagem']['name'];


$sql = "UPDATE rfa_site_governadores SET imagem_governador = '$recebeimg' WHERE cod_governador='$coduser' AND clube='$club'";
...
<html>
	<head>
		...
		<title>Imagem do Governador</title>
...
<script src="https://kit.fontawesome.com/13f03eba23.js" crossorigin="anonymous"></script>
	...
	<body>
		...
		<?php
			...
			$tem_crop	= false;
			$img		= '';
			$caminho = "images/sites/clube".$club."/governadores/".$data."-".$imagem['name'];
			if( $imagem['tmp_name'] ) 
			{
				...
				$(function(){
					...
					$('#btn-crop').click(function(){
						$.post( 'crop.php', {
							...
							window.location = "https://www.clubedigital.ong.br/painel/governador";
						});
						return false;
					});
				});
		...
		<?php else: ?>
			<h1>UPLOAD DE IMAGEM DO GOVERNADOR</h1>

			<form name="frm-jcrop" id="frm-jcrop" method="post" action="crop-governador.php" enctype="multipart/form-data" runat="server"  onsubmit="ShowLoading(); ">
										...
										<div class="row" style="margin-bottom: 15px">
                                    		<div class="col-12">
                                                ...
                                                <span class="fake-btn"><strong style="color:#4272d7"><i class="fas fa-cloud-upload-alt" style="margin-right: 15px; font-size: 25px;"></i> Imagem do Governador</strong></span>
                                                <span class="file-msg">escolha ou arraste aqui...</span>
