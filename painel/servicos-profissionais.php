...
$qrh = "SELECT * FROM rfa_servicos_profissionais WHERE clube='$clube'";
            ...
            <div class="col-lg-12">
                                ...
                                <div class="user-data m-b-30">
									...
									<h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-assignment"></i>Serviços Profissionais
									<a href="cd_serv_profissionais.php" role="button" class="btn btn-success">
...
<div class="rs-select2--dark rs-select2--md m-r-10 rs-select2--border" style="margin-left: 35px">
                                    ...
                                    <div class="table-responsive table-data">
                                        <table class="table">
                                            ...
                                            <tbody>
											<?php if($totalRows_lish <= 0){echo "<tr><td colspan='6' align='center'>Nenhum serviço profissional encontrado!</td></tr>";}else{?>
											<?php do{ ?>
                                                <tr>
                                                    <td>
                                                        <label class="au-checkbox">
                                                    ...
                                                    <td>
                                                        <div class="table-data__info">
                                                            ...
                                                            <h6><?php echo $row_lish['dia_prof'];?></h6>
													...
													<td>
                                                        <div class="table-data__info">
                                                            ...
                                                            <span class="block-email">
															  ...
															  echo strtoupper(strftime('%B',strtotime(date("Y")."-".$row_lish['mes_prof']."-"."01")));?>
                                                            </span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                       <a href="edt_serv_profissionais.php?id_profissional=<?php echo $row_lish['id_prof'];?>&clube=<?php echo $_SESSION['clube'];?>">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </a>
                                                    </td>
													<td>
                                                       <a href="excluir-serv-profissionais.php?id_profissional=<?php echo $row_lish['id_prof'];?>&clube=<?php echo $_SESSION['clube'];?>" class="exclui">
