                                    ...
                                    <div class="card-body card-block">
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<?php if($row_lis['categoria_socio'] == "rp"){?>
													<option value="rp" selected>Representativo</option>
													<option value="hn">Honorário</option>
												<?php }elseif($row_lis['categoria_socio'] == "hn"){ ?>
													<option value="rp">Representativo</option>
													<option value="hn" selected>Honorário</option>
												<?php }else{ ?>
										...
										<div class="col-12 col-md-4">
											<div class="form-group">
												...
												<input type="text" name="classif_socio" id="classif_socio" class="form-control" value="<?php echo $row_lis['classif_socio'];?>" required placeholder="Digite a classificação do sócio">
											</div>
										</div>
										</div>
                                        ...
                                        <div class="row form-group">
											...
											<div class="form-group">
												...
												<input type="text" name="id_ri_socio" id="id_ri_socio" class="form-control" value="<?php echo $row_lis['id_ri_socio'];?>" required placeholder="Digite o ID do Sócio">
											</div>
										</div>
											<div class="col-12 col-md-4">
											<div class="form-group">
												<label for="data_admissao" class=" form-control-label">Data de Admissão</label>
												<input type="date" name="data_admissao" id="data_admissao" class="form-control" value="<?php echo $row_lis['data_admissao'];?>" required>
											</div>
										</div>
										<div class="col-12 col-md-4">
											<div class="form-group">
												<label for="padrinho" class=" form-control-label">Padrinho</label>
												<input type="text" name="padrinho" id="padrinho" class="form-control" value="<?php echo $row_lis['padrinho'];?>" required placeholder="Digite o nome do Padrinho">
											</div>
										</div>
                                        </div>
										...
										<div class="row form-group">
											...
											<div class="form-group">
												...
												<input type="text" name="rg_socio" id="rg_socio" class="form-control" value="<?php echo $row_lis['rg_socio'];?>" required>
											</div>
										</div>
                                            <div class="col-12 col-md-3">
											<div class="form-group">
												<label for="cpf_socio" class=" form-control-label">CPF Sócio</label>
												<input type="text" name="cpf_socio" maxlength="14" onkeydown="javascript: fMasc( this, mCPF );" value="<?php echo $row_lis['cpf_socio'];?>" id="cpf_socio" class="form-control" onBlur="faz()"  required>
											</div>
											...
											<div class="form-group">
												...
												<input type="date" name="data_nascto_socio" id="data_nascto_socio" class="form-control" value="<?php echo $row_lis['data_nascto_socio'];?>" required>
											</div>
										</div>
										<div class="col-12 col-md-3">
											<div class="form-group">
												...
												<select name="sexo" class="form-control">
													<?php if($row_lis['sexo'] == 'm'){ ?>
													<option>Selecione o sexo...</option>
													<option value="m" selected>Masculino</option>
													<option value="f">Feminino</option>
												<?php }elseif($row_lis['sexo'] == 'f'){ ?>
													<option>Selecione o sexo...</option>
										...
										<div class="row form-group">
											...
											<div class="form-group">
												...
												<input type="text" name="conjuge" id="conjuge" class="form-control" value="<?php echo $row_lis['conjuge'];?>" placeholder="Digite o nome do cônjuge">
											</div>
										</div>
											<div class="col-12 col-md-3">
											<div class="form-group">
												<label for="data_nascto_conjuge" class=" form-control-label">Data de Nascimento do Cônjuge</label>
												<input type="date" name="data_nascto_conjuge" id="data_nascto_conjuge" value="<?php echo $row_lis['data_nascto_conjuge'];?>" class="form-control">
											</div>
										</div>
										<div class="col-12 col-md-3">
											<div class="form-group">
												<label for="telefone_socio" class=" form-control-label">Telefone do cônjuge</label>
												<input type="tel" name="telefone_conjuge" id="telefone_conjuge" value="<?php echo $row_lis['telefone_conjuge'];?>" maxlength="14" onkeydown="javascript: fMasc( this, mTel );"  class="form-control">
											</div>
										</div>
										<div class="col-12 col-md-3">
											<div class="form-group">
												<label for="telefone_socio" class=" form-control-label">Data de casamento</label>
												<input type="date" name="data_casamento" id="data_casamento" value="<?php echo $row_lis['data_casamento'];?>" class="form-control">
											</div>
										</div>
                                        </div>
										...
										<div class="col-12 col-md-3">
											<div class="form-group">
												...
												<select name="estado_socio" id="estado_socio" class="form-control">
													<option <?php if($row_lis['estado_socio'] == ""){echo "selected";}; ?>></option>
													<option value="AC" <?php if($row_lis['estado_socio'] == "AC"){echo "selected";}; ?>>Acre</option>
													<option value="AL" <?php if($row_lis['estado_socio'] == "AL"){echo "selected";}; ?>>Alagoas</option>
													<option value="AP" <?php if($row_lis['estado_socio'] == "AP"){echo "selected";}; ?>>Amapá</option>
													<option value="AM" <?php if($row_lis['estado_socio'] == "AM"){echo "selected";}; ?>>Amazonas</option>
													<option value="BA" <?php if($row_lis['estado_socio'] == "BA"){echo "selected";}; ?>>Bahia</option>
													<option value="CE" <?php if($row_lis['estado_socio'] == "CE"){echo "selected";}; ?>>Ceará</option>
													<option value="DF" <?php if($row_lis['estado_socio'] == "DF"){echo "selected";}; ?>>Distrito Federal</option>
													<option value="ES" <?php if($row_lis['estado_socio'] == "ES"){echo "selected";}; ?>>Espírito Santo</option>
													<option value="GO" <?php if($row_lis['estado_socio'] == "GO"){echo "selected";}; ?>>Goiás</option>
													<option value="MA" <?php if($row_lis['estado_socio'] == "MA"){echo "selected";}; ?>>Maranhão</option>
													<option value="MT" <?php if($row_lis['estado_socio'] == "MT"){echo "selected";}; ?>>Mato Grosso</option>
													<option value="MS" <?php if($row_lis['estado_socio'] == "MS"){echo "selected";}; ?>>Mato Grosso do Sul</option>
													<option value="MG" <?php if($row_lis['estado_socio'] == "MG"){echo "selected";}; ?>>Minas Gerais</option>
													<option value="PA" <?php if($row_lis['estado_socio'] == "PA"){echo "selected";}; ?>>Pará</option>
													<option value="PB" <?php if($row_lis['estado_socio'] == "PB"){echo "selected";}; ?>>Paraíba</option>
													<option value="PR" <?php if($row_lis['estado_socio'] == "PR"){echo "selected";}; ?>>Paraná</option>
													<option value="PE" <?php if($row_lis['estado_socio'] == "PE"){echo "selected";}; ?>>Pernambuco</option>
													<option value="PI" <?php if($row_lis['estado_socio'] == "PI"){echo "selected";}; ?>>Piauí</option>
													<option value="RJ" <?php if($row_lis['estado_socio'] == "RJ"){echo "selected";}; ?>>Rio de Janeiro</option>
													<option value="RN" <?php if($row_lis['estado_socio'] == "RN"){echo "selected";}; ?>>Rio Grande do Norte</option>
													<option value="RS" <?php if($row_lis['estado_socio'] == "RS"){echo "selected";}; ?>>Rio Grande do Sul</option>
													<option value="RO" <?php if($row_lis['estado_socio'] == "RO"){echo "selected";}; ?>>Rondônia</option>
													<option value="RR" <?php if($row_lis['estado_socio'] == "RR"){echo "selected";}; ?>>Roraima</option>
													<option value="SC" <?php if($row_lis['estado_socio'] == "SC"){echo "selected";}; ?>>Santa Catarina</option>
													<option value="SP" <?php if($row_lis['estado_socio'] == "SP"){echo "selected";}; ?>>São Paulo</option>
													<option value="SE" <?php if($row_lis['estado_socio'] == "SE"){echo "selected";}; ?>>Sergipe</option>
													<option value="TO" <?php if($row_lis['estado_socio'] == "TO"){echo "selected";}; ?>>Tocantins</option>
													<option value="EX" <?php if($row_lis['estado_socio'] == "EX"){echo "selected";}; ?>>Estrangeiro</option>
												</select>
											</div>
										</div>
