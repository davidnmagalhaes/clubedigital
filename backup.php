...
Zip('painel/images', 'backup/images.zip');
Zip('painel/site/images/uploads', 'backup/siteimages.zip');

//BACKUP BANCO DE DADOS
$data = date('Y-m');
define("DB_USER", 'u907456875_clubedigital');
define("DB_PASSWORD", 'Emmgd2180');
define("DB_NAME", 'u907456875_clubedigital');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'backup/'.$data); // Comment this line to use same script's directory ('.')
